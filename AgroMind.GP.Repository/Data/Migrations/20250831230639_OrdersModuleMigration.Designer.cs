...
namespace AgroMind.GP.Repository.Data.Migrations
{
    ...
    [Migration("20250831230639_OrdersModuleMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Identity.Addresses", b =>
                {
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Orders.DeliveryMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Orders.OrderItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Identity.Addresses", b =>
                {
                    b.HasOne("AgroMind.GP.Core.Entities.Identity.AppUser", "AppUser")
                        .WithOne("Addresses")
                        .HasForeignKey("AgroMind.GP.Core.Entities.Identity.Addresses", "Id")
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Orders.Order", b =>
                {
                    b.HasOne("AgroMind.GP.Core.Entities.Orders.DeliveryMethod", "DeliveryMethod")
                        .WithMany()
                        .HasForeignKey("DeliveryMethodId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.OwnsOne("AgroMind.GP.Core.Entities.Orders.Address", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Orders.OrderItems", b =>
                {
                    b.HasOne("AgroMind.GP.Core.Entities.Orders.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("AgroMind.GP.Core.Entities.Orders.ProductItemOrdered", "Product", b1 =>
                        {
