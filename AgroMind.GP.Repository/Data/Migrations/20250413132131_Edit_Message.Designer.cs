...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Message", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AgroMind.GP.Core.Entities.Message", b =>
                {
                    b.HasOne("AgroMind.GP.Core.Entities.Identity.Farmer", null)
                        .WithMany("Messages")
                        .HasForeignKey("FarmerId");

                    b.HasOne("AgroMind.GP.Core.Entities.Identity.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AgroMind.GP.Core.Entities.Identity.AppUser", "Sender")
                        .WithMany()
